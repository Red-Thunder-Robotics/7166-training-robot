...
public class Drive extends SubsystemBase {
    ...
    public void configurePathPlanner() {
        ...
        configureAutoBuilder(
                ...
                new ModifiedPPHolonomicDriveController(
                        new PIDConstants(DriveConstants.TRANSLATION_KP, 0d, 0d), new PIDConstants(12d, 0d, 0d)),
                PP_CONFIG,
    ...
    public void lowerDriveCurrentLimits() {
        for (final var module : modules) module.lowerDriveCurrentLimits();
    }

    public void increaseDriveCurrentLimits() {
        for (final var module : modules) module.increaseDriveCurrentLimits();
    }
    ...
    public void setRawGyroRotation(Rotation2d rotation) {
        gyroIO.setYawPosition(rotation);
    }
    ...
    public void setDriveGainP(double gainP) {
        if (gainP == lastDriveGainP) return;
