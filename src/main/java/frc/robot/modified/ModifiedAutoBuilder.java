...
public class ModifiedAutoBuilder {    
    ...
    /**
     * Configures the ModifiedAutoBuilder for using PathPlanner's built-in commands.
     *
    ...
    /**
     * Holder for all global variables directly referenced by ModifiedAutoBuilder.
     *
    ...
    /**
     * Configures the ModifiedAutoBuilder with custom path following command builder. Building pathfinding
    ...
    /**
     * Returns whether the ModifiedAutoBuilder has been configured.
     *
    ...
    /**
     * Returns whether the ModifiedAutoBuilder has been configured for pathfinding.
     *
    ...
    /**
     * Resets {@code ModifiedAutoBuilder} static state to the values set at class initialization time.
     *
    ...
    /**
     * Get if ModifiedAutoBuilder was configured for a holonomic drive train
     *
